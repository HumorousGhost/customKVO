...
//    self.person = [[Person alloc] init];
    [self.person customAddObserver:self forKeyPath:@"name" options:NSKeyValueObservingOptionNew context:NULL handlerBlock:^(id  _Nonnull observer, NSString * _Nonnull keyPath, NSDictionary<NSKeyValueChangeKey,id> * _Nonnull change, void * _Nonnull context) {
        NSLog(@"change = %@", change);
    }];
